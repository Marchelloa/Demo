...
class DT_Build:
    ...
    def __create_MA(self):
        '''метод добавление колонки значения **********************************'''
    ...
    def __create_DELTA(self):
        '''метод добавления колонки со значениями отклоения в % ****************************************'''
    ...
    def __create_pl(self):
        '''Метод добавления колонок с максимальным ******************************************************'''
...
class DataTicker(DT_Build):
    ...
    def __get_data(self):
        '''Метод загрузки данных из файла и конвертации в DataFrame'''
